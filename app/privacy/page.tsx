...
In demo mode (guest access), the user may stop using the demo by exiting demo mode; demo test data is deleted/cleared automatically (see section 7).`,
      ...
      {
        heading: "10. Children",
        content: `The Application is intended for corporate use and is not directed at children. We do not knowingly collect personal data from children.`,
      },
      {
        heading: "11. International Data Transfers",
        content: `Data may be processed on servers located in Kazakhstan. If international providers are involved in infrastructure or integrations, data may be transferred outside the country as necessary for functionality. In such cases, we implement appropriate safeguards in accordance with applicable laws.`,
      },
      {
  ...
  return (
    ...
    >
      <div className="flex flex-col px-4 pt-6 pb-8 md:px-8 md:pt-8 max-w-5xl mx-auto w-full flex-1">
        ...
        {/* White block - expanded, contains language switch, title, content */}
        <div
        ...
        >
          {/* Header inside white block: language toggle + title */}
          <div className="p-5 md:p-6 pb-0 flex-shrink-0">
            ...
            <div className="flex gap-2 mb-5">
              <button
                ...
                style={{
                  fontFamily: "'SF Pro Text', sans-serif",
                  background: lang === "ru" ? "#F35713" : "#ffffff",
                  color: lang === "ru" ? "#ffffff" : "#212121",
                  border: lang === "ru" ? "none" : "1px solid #e0e0e0",
                }}
              >
                RU
              </button>
              <button
                ...
                style={{
                  fontFamily: "'SF Pro Text', sans-serif",
                  background: lang === "en" ? "#F35713" : "#ffffff",
                  color: lang === "en" ? "#ffffff" : "#212121",
                  border: lang === "en" ? "none" : "1px solid #e0e0e0",
                }}
              >
                EN
              </button>
